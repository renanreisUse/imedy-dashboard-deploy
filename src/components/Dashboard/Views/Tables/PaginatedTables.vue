      ...
      <div class="card-content row">
        <div class="col-sm-6" id="table-itens">
          ...
          >
            <el-option
              class="select-default"
              v-for="item in Newpagination.perPageOptions"
              :key="item"
              :label="item"
              :value="item"
            >
        ...
        <div class="col-sm-12">
          ...
          >
            ...
            <el-table-column :min-width="120" fixed="right" label="AÇÕES">
        ...
        <div class="col-sm-6 pagination-info">
          <!--  <p class="category">Página {{from + 1}} a {{to}} de {{totalPages}} páginas</p> -->
        </div>
...
export default {
  ...
  computed: {
    ...
    rows() {
      return this.totalPages * this.Newpagination.perPage;
    }
  },
  data() {
    return {
